                                        ...
                                        <div class="box-2">
                                            <div class="box clearfix">
                                                <ul>
                                                    ...
                                                    <li><a href=""><i class="fa fa-eye" aria-hidden="true"></i> Category</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="box-2">
                                            <div class="box clearfix">
                                                <ul>
                                                    ...
                                                    <li><a href=""><i class="fa fa-eye" aria-hidden="true"></i> Products</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
...
?>
            ...
            <div>
                ...
                <table class="table table-striped my-3" style="border: 1px solid black; width: 300px;">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Category</th>
                ...
                <tbody>
                    <tr>
                    <?php
        $select_catergory = "select pCatName, pCatID from prodcategory";
        $stmt_select =  $pdo->prepare($select_catergory);
        $stmt_select -> execute(array());
        while($row_select = $stmt_select->fetch(PDO::FETCH_ASSOC)) 
        {
          echo "<td>".$row_select['pCatID'] ."</td>";  
          echo "<td>".$row_select['pCatName'] ."</td>";
          echo '</tr>';
        }
      ?>
