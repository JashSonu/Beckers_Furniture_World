<?php include 'nav.php' ?>
	...
	$stmt1 = $pdo->query("SELECT pID, pCatID, pName, pImage, pDesc  FROM products");
        ...
        <div class="popup-main mfp-hide" id="productid1">
            ...
            <div class="product">
                ...
                <div class="popup-content">
                    <iframe
                        src="https://docs.google.com/forms/d/e/1FAIpQLSdEvTsgWdqQqtGiUwAgTgt6D_ypEdyicDutgUqRR-f-x2ZQ5Q/viewform?embedded=true"
